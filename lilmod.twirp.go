...
/*
Package lilmod is a generated twirp stub package.
...
func NewAPIProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) API {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "lilmod", "API")
	urls := [1]string{
		serviceURL + "Proxy",
	}
...
func (c *aPIProtobufClient) Proxy(ctx context.Context, in *ProxyRequest) (*ProxyResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "lilmod")
...
const APIPathPrefix = "/twirp/lilmod.API/"
...
func (s *aPIServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "lilmod", "API")
}
