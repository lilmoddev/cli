...
/*
Package clipb is a generated twirp stub package.
...
func NewAPIProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) API {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "clipb", "API")
	urls := [1]string{
		serviceURL + "Proxy",
	}
...
func (c *aPIProtobufClient) Proxy(ctx context.Context, in *ProxyRequest) (*ProxyResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "clipb")
	ctx = ctxsetters.WithServiceName(ctx, "API")
	ctx = ctxsetters.WithMethodName(ctx, "Proxy")
	caller := c.callProxy
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *ProxyRequest) (*ProxyResponse, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*ProxyRequest)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*ProxyRequest) when calling interceptor")
					}
					return c.callProxy(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*ProxyResponse)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*ProxyResponse) when calling interceptor")
				}
...
func (c *aPIProtobufClient) callProxy(ctx context.Context, in *ProxyRequest) (*ProxyResponse, error) {
...
func (c *aPIJSONClient) callProxy(ctx context.Context, in *ProxyRequest) (*ProxyResponse, error) {
	out := new(ProxyResponse)
...
func NewAPIServer(svc API, opts ...interface{}) TwirpServer {
	...
	for _, opt := range opts {
		...
		case nil: // backwards compatibility, allow nil value for the argument
			continue
		default:
			panic(fmt.Sprintf("Invalid option type %T on NewAPIServer", o))
		}
	}
...
// APIPathPrefix is a convenience constant that could used to identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// that add a "/twirp" prefix by default, and use CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const APIPathPrefix = "/twirp/clipb.API/"
		...
		handler = func(ctx context.Context, req *ProxyRequest) (*ProxyResponse, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.API.Proxy(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*ProxyResponse)
...
func (s *aPIServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "clipb", "API")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
